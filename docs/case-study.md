...
The suite runs 706 tests across 120 files, covering 73 percent of the application logic. The
data access layer, 15 files of server actions, queries and clients, is left to integration
testing rather than mocked, which is why overall coverage reads 58 percent. Every push to
