...
The suite runs 651 tests across 113 files, covering 72 percent of the application logic. The
data access layer, 15 files of server actions, queries and clients, is left to integration
testing rather than mocked, which is why overall coverage reads 57 percent. Every push to
