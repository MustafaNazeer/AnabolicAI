...
The suite runs 770 tests across 128 files, covering 74 percent of the application logic. The
data access layer, 15 files of server actions, queries and clients, is left to integration
testing rather than mocked, which is why overall coverage reads 60 percent. Every push to
