...
The suite runs 550 tests across 102 files, covering 69 percent of the application logic. The
data access layer, 15 files of server actions, queries and clients, is left to integration
testing rather than mocked, which is why overall coverage reads 53 percent. Every push to
